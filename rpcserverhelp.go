...
var helpDescsEnUS = map[string]string{
	...
	"createrawtransaction-amounts--desc":  "The destination address as the key and the amount in CTT as the value",
	...
	"getblocktemplateresulttx-fee":     "Difference in value between transaction inputs and outputs (in Mystiko)",
	...
	"getblocktemplateresult-coinbasevalue":              "Total amount available for the coinbase in Mystiko",
	...
	"infochainresult-relayfee":        "The minimum relay fee for non-free transactions in CTT/KB",
	...
	"infowalletresult-paytxfee":        "The transaction fee set in CTT/KB",
	...
	"gettxoutresult-value":         "The transaction amount in CTT",
